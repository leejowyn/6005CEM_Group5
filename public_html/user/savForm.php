  ...
  if (
    ...
    try {
      ...
      if ($queryInsert) {
          ...
          // Insert the record into log_activities table with the obtained consultation_id
          $queryRecord = mysqli_query($conn, "INSERT INTO log_activity(log_activity_id, event_type, user_id, consultation_id, datetime) 
          VALUES (0, 'consultation', $custID, $lastInsertedId, NOW())");
