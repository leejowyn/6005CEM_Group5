  ...
  <div class="page">
    <section class="section section-relative section-header">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="index.php"><img class="brand-logo-dark" src="images/logo.png" alt="" width="232" height="67" />
                      <img class="brand-logo-light" src="images/logo-inverse-86x104.png" alt="" width="86" height="104" /></a>
                  </div>
                </div>
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    if (isset($_SESSION['user_id'])) {
                      echo '<li class="rd-nav-item"><a class="rd-nav-link" href="profile.php">Profile</a></li>';
                    }
                    ?>
                  </ul>
                </div>
      ...
      <section class="section context-dark section-jumbotron bg-cover" style="background: url(images/bg-image.jpg) #151515">
        <div class="panel-left"><a class="brand" href="index.php"><img class="brand-logo-dark" src="images/logo.png" alt="" width="232" height="67" />
            <img class="brand-logo-light" src="images/logo-inverse.png" alt="" width="86" height="104" /></a>
          ...
          <div class="section-fullheight-inner section-md text-center text-lg-left">
            <div class="container">
              <div class="row justify-content-center justify-content-lg-start">
                <div class="col-md-10 offset-lg-1 col-lg-8 offset-xl-1 col-xl-9 offset-xxl-2 col-xxlH-7">
                  <div class="jumbotron-custom-1">

                    <div class="text-1 font-weight-medium">Welcome to In Haus</div>
                    <div class="title text-decorative">Top-Notch</div>
                    <div class="title">Interior + Staging</div>
                    <p class="big-2 text-white-darken">With 19+ years’ experience in combining traditions and innovations, In Haus creates settings to inspire the way people live, learn, heal, work and play.</p>
                  </div>
                </div>
              </div>
            </div>
